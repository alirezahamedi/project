...
<div class="Popular">
    <h2>دوره های محبوب نوتاش</h2>
    <hr class="fav-hr">
    <div class="cards-content" id="cards-content"></div>
    <div class="readMore">
        <a href="courses.php">
            <button>آموزش های بیشتر
...
<div class="news">
    <div class="news-title"><span class="text">آخرین اخبار نوتاش</span></div>
    <hr class="news-hr">
    <div class="news-content" id="news-content"></div>
</div>

<div class="discount">
    <h2>دوره های تخفیف دار نوتاش</h2>
    <hr class="offer-hr">
    <div class="discount-content" id="discount-content"></div>
    <div class="readMore">
        <a href="courses.php">
            <button>آموزش های بیشتر
                <i class="fa fa-arrow-left" aria-hidden="true"></i>
...
<div class="comment-container">
    <div class="comment-title"><span class="text">نظرات دانشجویان نوتاش</span></div>
    <hr class="comment-hr">
...
<div class="manager-section">
    <div class="manager-img">
        <div class="drop">
            <img src="img/manage.png" alt="avatar">
        </div>
    </div>
    <div class="manager-txt">
        <h3>مدیریت آموزشگاه نوتاش با سارا دادرس</h3>
        <span>با بیش از ... سال سابقه مدیریتی وآموزشی</span>
    </div>
</div>

<div class="articles">
    <div class="articles-title">آخرین مقالات نوتاش</div>
    <hr class="articles-hr">
    <div class="articles-content" id="articles-content"></div>
    <div class="readMore">
        <a href="article.php">
            <button>مشاهده مقالات بیشتر
                <i class="fa fa-arrow-left" aria-hidden="true"></i>
            </button>
        </a>
    </div>
