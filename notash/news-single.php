...
<div class="latest-news">
    ...
    <div class="news-body">
        ...
        <br> <br>
        <span>ساعت های برگزاری: </span>
        <br><br>
        <span>
            <i class="fa fa-star" style="color:rgb(230, 230, 16)"></i>
            ویژه نوجوانان و بزرگسالان و مشاغل (ورود به بازارکار)
        </span>
        <br><br>
        ...
        <b>
            <i class="fa fa-star" style="color:rgb(230, 230, 16)"></i>
            پرداخت شهریه بصورت اقساط میباشد.</b>
        <br>
        <div class="btn">
            <button type="submit">ثبت نام در دوره</button>
        </div>
    </div>
</div>
    ...
    <div class="container-box">
        <div class="container-title">
            <span>
                ...
                آموزش و اخذ مدرک فنی حرفه ای درکمترین زمان درآموزشگاه نوتاش
            </span>
        </div>
        <div class="img-vocational">
            <img src="img/vocational.png" alt="vocational">
        </div>
        <div class="container-call">
            <p>
                با شرکت دردوره <b id="news-name-participation"></b> موفق به اخذ مدرک معتبرسازمان فنی حرفه ای شوید.
            </p>
            <p> جهت کسب اطلاعات بیشتر با آموزشگاه نوتاش تماس بگیرید
                <i class="fa fa-caret-down"></i>
            </p>
            <button>
                <a href="tel:02165151450">تماس با آموزشگاه نوتاش
                    <i class="fa fa-phone"></i>
                </a>
            </button>
        </div>
...
<div class="user-questions">
    <div class="news-title-single">
        <h2>سؤالات متدوال کاربران</h2>
    </div>
    <div class="news-body">
        <span id="news-question-1"></span>
        <p id="news-answer-1"></p>
        <br>
        <span id="news-question-2"></span>
        <p id="news-answer-2"></p>
        <ul>
            <li id="news-answer-3"></li>
            <li id="news-answer-4"></li>
            <li id="news-answer-5"></li>
        </ul>
        <br>
        <span id="news-question-3"></span>
        <ul>
            <li id="news-answer-6"></li>
            <li id="news-answer-7"></li>
            <li id="news-answer-8"></li>
        </ul>
        <br>
        <span id="news-question-4"></span>
        <p id="news-answer-9"></p>
    </div>
</div>
...
<script type="text/javascript" src="js/news-single.js"></script>
